...
import net.delta.client.events.event.SneakEvent;
import net.delta.client.gui.DeltaFontRenderer;
import net.delta.client.gui.InputField;
import net.delta.client.gui.slideout.Dropdown;
import net.delta.client.gui.slideout.Label;
import net.delta.client.gui.slideout.ModPreviewRenderer;
import net.delta.client.gui.slideout.Padding;
import net.delta.client.gui.slideout.SlidePage;
import net.delta.client.gui.slideout.SlideoutGUI;
import net.delta.client.gui.slideout.Slider;
import net.delta.client.gui.slideout.TextButton;
import net.delta.client.gui.slideout.elements.ColorPicker;
import net.delta.client.gui.slideout.fontrenderer.CustomFontRenderer;
import net.delta.client.mods.render.RenderMod;
import net.delta.client.mods.render.color.ModColor;
import net.delta.client.mods.render.gui.BoxedCoord;
...
public class ToggleSneak extends RenderMod
{
    ...
    public void createCogMenu()
    {
        ...
        this.inventorySneakButton.setToolTipText("Inventory Sneak is not fair");
