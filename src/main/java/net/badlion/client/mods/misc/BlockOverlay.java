...
public class BlockOverlay extends Mod
{
    ...
    public void createCogMenu()
    {
        ...
        this.slideCogMenu.addElement(new Label(this.getName(), -1, 16, DeltaFontRenderer.FontType.TITLE, false));
        this.slideCogMenu.addElement(new Padding(slideoutgui.getSlideoutWidth() - 25, 8));
        this.slideCogMenu.addElement(new Label("Settings", -7894388, 12, DeltaFontRenderer.FontType.TITLE, true));
